...
<script type="text/javascript">
  var timeDisplay = document.getElementById("kotak");
...
<script>
  ...
  client.onConnectionLost = function (responseObject) {
    document.getElementById("mySwitch1").innerHTML = "Koneksi Ke Broker MQTT Putus - " + responseObject.errorMessage + "<br/>";
  };
  ...
  client.onMessageArrived = function (message) {
   ...
   document.getElementById("mySwitch2").innerHTML = temp1 + " °C";
   document.getElementById("mySwitch3").innerHTML = humadity1 + " HR";
      //document.write(temp);
      //console.log(temp);
 ...
 var options = {
  ...
  onSuccess: function () {
    document.getElementById("mySwitch1").innerHTML += "Koneksi Ke Broker MQTT Sukses" + "<br/>";
  ...
  onFailure: function (message) {
    document.getElementById("mySwitch1").innerHTML += "Koneksi ke Broker MQTT Gagal - " + message.errorMessage + "<br/>";
  },
...
document.getElementById("mySwitch1").innerHTML += "Koneksi Ke Broker MQTT - Alamat: " + host + ":" + port + "<br/>";
